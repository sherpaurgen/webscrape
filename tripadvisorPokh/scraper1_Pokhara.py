...
url="https://www.tripadvisor.com/Hotels-g293891-Pokhara_Gandaki_Zone_Western_Region-Hotels.html"
...
for i in range(0,22):
    if pg == 0:
        ...
        urlnext = "https://www.tripadvisor.com/Hotels-g293891-Pokhara_Gandaki_Zone_Western_Region-Hotels.html"
        pg = pg + 30
        scrape(urlnext)

    else:
        print("Jumping next else")
        urlnext = 'https://www.tripadvisor.com/Hotels-g293891-oa'+str(pg)+'-Pokhara_Gandaki_Zone_Western_Region-Hotels.html'
        pg = pg + 30
        scrape(urlnext)
